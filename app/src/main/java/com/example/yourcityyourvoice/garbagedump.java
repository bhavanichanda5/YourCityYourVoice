...
public class garbagedump extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_garbagedump);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(R.drawable.baseline_arrow_back_24);
        toolbar.setNavigationOnClickListener(v -> onBackPressed());
        getSupportActionBar().setTitle("Garbage dump");
    ...
    private void saveDataToFirebase(String tvComplaintType,String tvPostedBy,String selectedArea, String additionalInfo, String imageUrl) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Complaints").child("garbage_dump");
