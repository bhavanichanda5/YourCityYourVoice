...
public class noelectricity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private TextView btnDirty, btnLackToilet, btnNearby;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_noelectricity);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(R.drawable.baseline_arrow_back_24);
        toolbar.setNavigationOnClickListener(v -> onBackPressed());
        getSupportActionBar().setTitle("No electricity");
    ...
    private void saveDataToFirebase(String tvComplaintType,String tvPostedBy,String selectedArea, String additionalInfo, String imageUrl) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Complaints").child("no_electricity");
