...
public class deadanimals extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private TextView btnDirty, btnLackToilet, btnNearby, btnSmelly, btnUnhygienic,stink,Unsanitary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deadanimals);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(R.drawable.baseline_arrow_back_24);
        toolbar.setNavigationOnClickListener(v -> onBackPressed());
        getSupportActionBar().setTitle("Dead animal(s)");
    ...
    private void initializeViews() {
        ...
        stink = findViewById(R.id.stink);
        Unsanitary = findViewById(R.id.Unsanitary);
    ...
    private void setupQuickSelectionListeners() {
        ...
        stink.setOnClickListener(quickSelectionListener);
        Unsanitary.setOnClickListener(quickSelectionListener);
    }
    ...
    private void saveDataToFirebase(String tvComplaintType,String tvPostedBy,String selectedArea, String additionalInfo, String imageUrl) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Complaints").child("dead_animals");
