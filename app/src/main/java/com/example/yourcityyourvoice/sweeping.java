...
public class sweeping extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private TextView btnDirty, btnLackToilet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sweeping not done");
    ...
    private void saveDataToFirebase(String tvComplaintType,String tvPostedBy,String selectedArea, String additionalInfo, String imageUrl) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Complaints").child("Sweeping");
